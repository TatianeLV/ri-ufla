...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    ...
    <oai_capes
      ...
      <!-- creator: RI-UFLA usa preferencialmente dc.contributor.author; mantemos dc.creator como fallback -->
      <xsl:for-each select="$dc/*[local-name()='element' and @name='creator'] | $dc/*[local-name()='element' and @name='contributor']/*[local-name()='element' and @name='author']">
        <creator>
          <dcterms:creator>
